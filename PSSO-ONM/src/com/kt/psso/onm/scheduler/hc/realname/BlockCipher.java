...
public abstract class BlockCipher 
{
	...
	/**
	 * @uml.property  name="pad"
	 * @uml.associationEnd  
	 */
	private Padding pad = new PKCS5Padding();
	/**
	 * @uml.property  name="paddingType"
	 */
	...
	// Cipher 입력 버퍼
	/**
	 * @uml.property  name="inputBuffer" multiplicity="(0 -1)" dimension="1"
	 */
	protected byte inputBuffer[];
	/**
	 * @uml.property  name="inputBufferOffset"
	 */
	protected int inputBufferOffset;
	/**
	 * @uml.property  name="inputBufferLen"
	 */
	protected int inputBufferLen;
	
	// Cipher 운영 모드에서 사용될 중간 버퍼
	/**
	 * @uml.property  name="chainBlock" multiplicity="(0 -1)" dimension="1"
	 */
